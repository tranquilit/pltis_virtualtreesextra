...
override PACKAGE_NAME=pl_virtualtreesextra
override PACKAGE_VERSION=6.0.1
ifndef LCL_PLATFORM
...
override TARGET_UNITS+=pl_virtualtreesextra.pas
endif
...
ifeq ($(FULL_TARGET),i386-linux)
override COMPILER_INCLUDEDIR+=source
endif
ifeq ($(FULL_TARGET),i386-go32v2)
override COMPILER_INCLUDEDIR+=source
endif
