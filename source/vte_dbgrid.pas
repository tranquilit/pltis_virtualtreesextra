...
type
  ...
  private
    ...
    procedure UpdateDBTree(StartNode: PVirtualNode; NodeCount: Cardinal; AlwaysUpdate: Boolean; UpdateLoadedData: Boolean);
...
procedure TCustomVirtualDBGrid.UpdateDBTree(StartNode: PVirtualNode; NodeCount: Cardinal; AlwaysUpdate: Boolean; UpdateLoadedData: Boolean);
var
  Count: Cardinal;
