...
Type
  ...
  Protected
    ...
    Procedure DoDragDrop(Source: TObject; DataObject: IDataObject; Formats: TFormatArray; Shift: TShiftState; const Pt: TPoint;
                         var Effect: DWORD; Mode: TDropMode); Override;
  ...
  Public
    ...
    Procedure OnDragOverHandler(Sender: TBaseVirtualTree; Source: TObject; Shift: TShiftState; State: TDragState;
                   const Pt: TPoint; Mode: TDropMode; var Effect: DWORD; var Accept: Boolean);
...
Procedure TBaseVirtualDBTree.DoDragDrop(Source: TObject; DataObject: IDataObject; Formats: TFormatArray; Shift: TShiftState; const Pt: TPoint;
                         var Effect: DWORD; Mode: TDropMode);
Var
  CanProcess: Boolean;
  Focus: PVirtualNode;
Begin
...
Procedure TBaseVirtualDBTree.OnDragOverHandler(Sender: TBaseVirtualTree; Source: TObject; Shift: TShiftState; State: TDragState;
                   const Pt: TPoint; Mode: TDropMode; var Effect: DWORD; var Accept: Boolean);
Begin
...
Procedure TBaseVirtualDBTree.GoToRec(AString: String; Mode: TDBVTGoToMode);
Var
  Text: String;
  Node: PVirtualNode;
  Column: TColumnIndex;
...
Procedure TVirtualDBTree.DoGetText(Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var Text: String);
Begin
...
Procedure TVirtualDBTree.DoNewText(Node: PVirtualNode; Column: TColumnIndex; const Text: String);
Begin
...
Procedure TDBCheckVirtualDBTree.DoGetText(Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var Text: String);
Begin
  If Assigned(Node) And (Node <> RootNode) Then Begin
    If (Column = Header.MainColumn) And (TextType = ttNormal) Then Text := NodeText[Node]
    Else Inherited;
...
Procedure TDBCheckVirtualDBTree.DoNewText(Node: PVirtualNode; Column: TColumnIndex; const Text: String);
Begin
  If Column = Header.MainColumn Then ViewField.AsString := Text;
End;
...
Procedure TCheckVirtualDBTree.DoGetText(Node: PVirtualNode; Column: TColumnIndex; TextType: TVSTTextType; var Text: String);
Begin
  If Assigned(Node) And (Node <> RootNode) Then Begin
    If (Column = Header.MainColumn) And (TextType = ttNormal) Then Text := NodeText[Node]
    Else Inherited;
...
Procedure TCheckVirtualDBTree.DoNewText(Node: PVirtualNode; Column: TColumnIndex; const Text: String);
Begin
  If Column = Header.MainColumn Then ViewField.AsString := Text;
End;
